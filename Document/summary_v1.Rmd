...
By analyzing the method of crimes, we found that some criminals carried weapons, but others were not. Based on whether carrying weapons or not, we can preliminarily judge the risk factor of the type of crime. We found that approximately 7.02% of the crimes are committed with weapons. There are 1598 crimes in which the criminals used a gun, 772 crimes in which the criminal used knife.
...
Different types of crimes occurred in District 4, even the THEFTS are the most, other kinds of crimes including burglaries, robberies and sex abuses happened frequently. It is noteworthy that there had been several ASSAULTS WITH WEAPONS in this area.
